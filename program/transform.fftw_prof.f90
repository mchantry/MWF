...
!------------------------------------------------------------------------
   subroutine tra_spec2phys(s, p)
      ...
      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"s2p fftw 1 : ",t_stop-t_start 
      call tra_time(t_start)

      call tra_T2Ts()

      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"s2p tran : ",t_stop-t_start 
      ...
      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"s2p fftw 2 : ",t_stop-t_start 
...
!------------------------------------------------------------------------
   subroutine tra_phys2spec(p, s)
      ...
      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"p2s fftw 1 : ",t_stop-t_start 
      call tra_time(t_start)

      call tra_Ts2T

      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"p2s tran  : ",t_stop-t_start 
      call tra_time(t_start)
      ...
      call tra_time(t_stop)
      if (mpi_rnk==0) print*,"p2s fftw2  : ",t_stop-t_start 
